			...
			<CardContent className="p-5">
				...
				<div className="mt-3 space-y-3 text-sm leading-relaxed text-muted-foreground">
					...
					<p>
						...
						running low across most of the sample. That ordering is not noise: a
						call price bounds the fundamental value from above and a put price
						bounds it from below, so the two one-sided series bracket the
						combined one. Both bounds are sharpest at deep in-the-money strikes,
						which are the least liquid contracts on the board, so in practice
						both stay loose. Read the combined series for a number and the
						spread between the other two as a measure of how much the option
						market actually pins down.
					</p>
				</div>
